...
export default function LabelEditor({ layout: initial, onSave, onCancel }: Props) {
  ...
  const ui = {
    ...
    sidebar: 'w-60 border-r border-[#30363d] flex flex-col gap-0 overflow-y-auto scrollbar-dark shrink-0',
    canvas:  'flex-1 flex flex-col items-center justify-center bg-[#161b22] p-6 overflow-auto scrollbar-dark',
    props:   'w-56 border-l border-[#30363d] flex flex-col gap-0 overflow-y-auto scrollbar-dark shrink-0',
